...
if __name__ == "__main__":
    ...
    testll10  = folder + '/collapsed-output-Q5-4-10-0.5-0.1.txt-testll'
    testll20  = folder + '/collapsed-output-Q5-4-20-0.5-0.1.txt-testll'
    testll30  = folder + '/collapsed-output-Q5-4-30-0.5-0.1.txt-testll'
    testll40  = folder + '/collapsed-output-Q5-4-40-0.5-0.1.txt-testll'
    testll50  = folder + '/collapsed-output-Q5-4-50-0.5-0.1.txt-testll'
