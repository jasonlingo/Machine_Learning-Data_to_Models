...
if __name__ == "__main__":
    ...
    folder = "result"
    testll10  = folder + '/collapsed-output-Q5-6-l0.txt-testll'
    testll20  = folder + '/collapsed-output-Q5-6-l0.25.txt-testll'
    testll30  = folder + '/collapsed-output-Q5-6-l0.5.txt-testll'
    testll40  = folder + '/collapsed-output-Q5-6-l0.75.txt-testll'
    testll50  = folder + '/collapsed-output-Q5-6-l1.txt-testll'
