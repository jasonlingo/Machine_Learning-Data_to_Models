...
if __name__ == "__main__":
    ...
    folder = "result"
    testll10  = folder + '/collapsed-output-Q5-5-25-0.0-0.1.txt-testll'
    testll20  = folder + '/collapsed-output-Q5-5-25-0.25-0.1.txt-testll'
    testll30  = folder + '/collapsed-output-Q5-5-25-0.5-0.1.txt-testll'
    testll40  = folder + '/collapsed-output-Q5-5-25-0.75-0.1.txt-testll'
    testll50  = folder + '/collapsed-output-Q5-5-25-1.0-0.1.txt-testll'
